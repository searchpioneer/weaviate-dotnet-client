...
public class AggregateTests : TestBase
{
	...
	public void AggregateWithNearVector()
	{
		...
		{
			Class = CLASS_NAME_PIZZA, Fields = new[] { AdditionalField.Vector.AsAdditionalField() }
		});
		...
		var result = Client.Graph.Aggregate(new()
		{
			...
			Fields = new[] { new Field { Name = "meta", Fields = new Field[] { "count" } } }
		});
	...
	public void AggregateWithNearObjectAndCertainty()
	{
		...
		var vectorResult = Client.Graph.Get(new()
		{
			Class = CLASS_NAME_PIZZA, Fields = new[] { AdditionalField.Id.AsAdditionalField() }
		});
	...
	public void AggregateWithNearObjectAndDistance()
	{
		...
		var vectorResult = Client.Graph.Get(new() { Class = CLASS_NAME_PIZZA, Fields = new[] { "id".AsAdditional() } });
	...
	public void AggregateWithNearTextAndCertainty()
	{
		...
		{
			Class = CLASS_NAME_PIZZA,
			NearText = new() { Concepts = new[] { CLASS_NAME_PIZZA }, Certainty = 0.7f },
			Fields = new[] { new Field { Name = "meta", Fields = new[] { new Field { Name = "count" } } } }
		});
	...
	public void AggregateWithNearTextAndDistance()
	{
		...
		{
			Class = CLASS_NAME_PIZZA,
			NearText = new() { Concepts = new[] { CLASS_NAME_PIZZA }, Distance = 0.6f },
			Fields = new[] { new Field { Name = "meta", Fields = new[] { new Field { Name = "count" } } } }
		});
	...
	public void AggregateWithObjectLimitAndDistance()
	{
		...
		{
			Class = CLASS_NAME_PIZZA,
			NearText = new() { Concepts = new[] { CLASS_NAME_PIZZA }, Distance = 0.3f },
			ObjectLimit = 1,
			Fields = new[] { new Field { Name = "meta", Fields = new[] { new Field { Name = "count" } } } }
		});
