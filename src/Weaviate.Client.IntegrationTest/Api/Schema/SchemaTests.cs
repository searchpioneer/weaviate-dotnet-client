...
namespace SearchPioneer.Weaviate.Client.IntegrationTest.Api.Schema;
...
public class SchemaTests : TestBase
{
    ...
    public void CreateBandClass()
    {
        ...
        var createStatus = Client.Schema.CreateClass(new("Band")
        {
    ...
    public void CreateRunClass()
    {
        ...
        var createStatus = Client.Schema.CreateClass(new("Run")
        {
    ...
    public void CreateClassExplicitVectorizerWithProperties()
    {
        ...
        var createStatus = Client.Schema.CreateClass(new("Article")
        {
    ...
    public void CreateClassExplicitVectorizerWithArrayProperties()
    {
        ...
        var createStatus = Client.Schema.CreateClass(new("ClassArrays")
        {
