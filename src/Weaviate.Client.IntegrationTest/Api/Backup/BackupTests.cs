...
namespace SearchPioneer.Weaviate.Client.IntegrationTest.Api.Backup;
...
public class BackupTests : TestBase
{
    ...
    public void CreateAndRestoreBackupWithWaiting()
    {
        ...
        var backup = Client.Backup.Create(new(Backend.Filesystem, backupId)
        {
            IncludeClasses = new[]
            {
                CLASS_NAME_PIZZA
        ...
        var backupStatus = Client.Backup.GetStatus(new(Backend.Filesystem, backupId));
        ...
        var restore = Client.Backup.Restore(new(Backend.Filesystem, backupId)
        {
            IncludeClasses = new[]
            {
                CLASS_NAME_PIZZA
        ...
        var restoreStatus = Client.Backup.GetRestoreStatus(new(Backend.Filesystem, backupId));
    ...
    public void FailOnCreateOfExistingBackup()
    {
        ...
        var backup2 = Client.Backup.Create(new(Backend.Filesystem, backupId)
        {
            IncludeClasses = new[]
            {
                CLASS_NAME_PIZZA
