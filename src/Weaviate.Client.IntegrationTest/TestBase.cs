...
namespace SearchPioneer.Weaviate.Client.IntegrationTest;
...
public abstract class TestBase
{
    ...
    protected readonly WeaviateClient Client = new(new("http", "localhost:8080"), HttpClient);
    ...
    protected static void CreateWeaviateTestSchemaFood(WeaviateClient client)
    {
        ...
        var pizzaCreateStatus = client.Schema.CreateClass(new(CLASS_NAME_PIZZA)
        {
        ...
        var soupCreateStatus = client.Schema.CreateClass(new(CLASS_NAME_SOUP)
        {
