...
public class ObjectsPathTests
{
    ...
    private static readonly ObjectPathParams ClassParams = new()
    {
        Class = "someClass"
    };

    private static readonly ObjectPathParams IdParams = new()
    {
        Id = "someId"
    };

    private static readonly ObjectPathParams ClassQueryParams = new()
    {
        Class = "someClass",
        Limit = 100
    };
