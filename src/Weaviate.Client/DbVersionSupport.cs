...
public class DbVersionSupport
{
    ...
    public DbVersionSupport(string version)
    {
        _version = version;
    }
    ...
    {
        return $"WARNING: Usage of objects paths without class is deprecated in Weaviate {_version}." +
               " Please provide class parameter\n";
    }

    public string GetWarnDeprecatedNonClassNameNamespacedEndpointsForReferences()
    {
        return $"WARNING: Usage of references paths without class is deprecated in Weaviate {_version}." +
               " Please provide class parameter\n";
    }

    public string GetWarnDeprecatedNonClassNameNamespacedEndpointsForBeacons()
    {
        return $"WARNING: Usage of beacon paths without class is deprecated in Weaviate {_version}." +
               " Please provide class parameter\n";
    }

    public string GetWarnNotSupportedClassNamespacedEndpointsForObjects()
    {
        return $"WARNING: Usage of objects paths with class is not supported in Weaviate {_version}." +
               " class parameter is ignored\n";
    }

    public string GetWarnNotSupportedClassParameterInEndpointsForObjects()
    {
        return $"WARNING: Usage of objects paths with class query parameter is not supported in Weaviate {_version}." +
               " class query parameter is ignored\n";
    }

    public string GetWarnNotSupportedClassNamespacedEndpointsForReferences()
    {
        return $"WARNING: Usage of references paths with class is not supported in Weaviate {_version}." +
               " class parameter is ignored\n";
    }

    public string GetWarnNotSupportedClassNamespacedEndpointsForBeacons()
    {
        return $"WARNING: Usage of beacons paths with class is not supported in Weaviate {_version}." +
               " class parameter is ignored\n";
    }
}