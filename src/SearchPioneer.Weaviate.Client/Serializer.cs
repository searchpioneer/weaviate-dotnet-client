...
{
	public readonly JsonSerializerOptions _jsonSerializerOptions = new()
    {
    ...
    public string Serialize<T>(T @object) => JsonSerializer.Serialize(@object, _jsonSerializerOptions);
}
