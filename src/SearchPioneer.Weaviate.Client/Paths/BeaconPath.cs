...
public class BeaconPath
{
    ...
    public BeaconPath(DbVersionSupport support) => _support = support;

    public virtual string BuildBatchFrom(BeaconPathParams pathParams, out List<string> warnings) => Build(pathParams, out warnings, AddClassName, AddId, AddProperty);

    public virtual string BuildBatchTo(BeaconPathParams pathParams, out List<string> warnings) => Build(pathParams, out warnings, AddClassNameDeprecatedNotSupportedCheck, AddId);

    public virtual string BuildSingle(BeaconPathParams pathParams, out List<string> warnings) => Build(pathParams, out warnings, AddClassNameDeprecatedNotSupportedCheck, AddId);
