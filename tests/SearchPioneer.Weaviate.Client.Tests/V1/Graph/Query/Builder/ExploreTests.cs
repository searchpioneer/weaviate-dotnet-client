...
public class ExploreTests : TestBase
{
	...
	public void QueryWithCertainty()
	{
		var query = new Explore
		{
			...
			Fields = new[]
			{
				ExploreFields.Certainty, ExploreFields.Distance, ExploreFields.Beacon, ExploreFields.ClassName
			}
		};
		Assert.Equal(
	...
	public void SimpleExplore()
	{
		var query = new Explore
		{
			NearText = new() { Concepts = new[] { "Cheese", "pineapple" } },
			Fields = new[] { ExploreFields.Certainty, ExploreFields.Beacon, ExploreFields.Distance }
		};
	...
	public void ExploreWithLimitAndCertainty()
	{
		var query = new Explore
		{
			NearText = new() { Concepts = new[] { "Cheese" }, Certainty = 0.71f },
			Fields = new[] { ExploreFields.Beacon }
		};
	...
	public void ExploreWithLimitAndDistance()
	{
		var query = new Explore
		{
			NearText = new() { Concepts = new[] { "Cheese" }, Distance = 0.71f },
			Fields = new[] { ExploreFields.Beacon }
		};
	...
	public void ExploreWithMove()
	{
		var query = new Explore
		{
			...
			{
				Concepts = new[] { "Cheese" },
				MoveTo = new() { Concepts = new[] { "pizza", "pineapple" }, Force = 0.2f },
				MoveAwayFrom = new() { Concepts = new[] { "fish" }, Force = 0.1f }
			},
			Fields = new[] { ExploreFields.Beacon }
		};
	...
	public void ExploreWithAllParams()
	{
		var query = new Explore
		{
			NearText = new()
			{
				...
				MoveTo = new() { Concepts = new[] { "publisher", "articles" }, Force = 0.5f },
				MoveAwayFrom = new() { Concepts = new[] { "fashion", "shop" }, Force = 0.2f }
			},
			Fields = new[]
			{
				ExploreFields.Certainty, ExploreFields.Distance, ExploreFields.Beacon, ExploreFields.ClassName
	...
	public void ExploreWithNearObjectAndCertainty()
	{
		var query = new Explore
		{
			NearObject = new() { Id = "some-uuid", Certainty = 0.8f },
			Fields = new[]
			{
				ExploreFields.Certainty, ExploreFields.Distance, ExploreFields.Beacon, ExploreFields.ClassName
			}
