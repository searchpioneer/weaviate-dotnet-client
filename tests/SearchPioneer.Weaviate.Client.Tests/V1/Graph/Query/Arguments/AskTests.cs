...
public class AskTests : TestBase
{
	...
	{
		var arg = new Ask { Question = "What's your name?" };
	...
	{
		var arg = new Ask { Question = "What's your name?", Properties = new[] { "prop1", "prop2" } };
	...
	{
		var arg = new Ask { Question = "What's your name?", Properties = new[] { "prop1", "prop2" }, Certainty = 0.8f };
	...
	{
		var arg = new Ask { Question = "What's your name?", Properties = new[] { "prop1", "prop2" }, Distance = 0.8f };
	...
	{
		var arg = new Ask { Question = "What's your name?", Autocorrect = true };
	...
	{
		var arg = new Ask { Question = "What's your name?", Rerank = false };
