...
public class NearTextTests : TestBase
{
	...
	{
		var nearText = new NearText { Concepts = new[] { "a", "b", "c" }, Certainty = 0.8f };
	...
	{
		var nearText = new NearText { Concepts = new[] { "a", "b", "c" }, Distance = 0.8f };
	...
	{
		var nearText = new NearText { Certainty = 0.8f };
	...
	{
		var nearText = new NearText { Distance = 0.8f };
	...
	public void MoveToWithCertainty()
	{
		var nearText = new NearText
		{
			Concepts = new[] { "a", "b", "c" },
			Certainty = 0.8f,
			MoveTo = new() { Concepts = new[] { "a1", "b2" }, Force = 0.1f }
		};
		Assert.Equal(
	...
	public void MoveToWithCertaintyWithoutForce()
	{
		var nearText = new NearText
		{
			Concepts = new[] { "a", "b", "c" }, Certainty = 0.8f, MoveTo = new() { Concepts = new[] { "a1", "b2" } }
		};
	...
	public void MoveToWithDistanceWithoutForce()
	{
		var nearText = new NearText
		{
			Concepts = new[] { "a", "b", "c" }, Distance = 0.8f, MoveTo = new() { Concepts = new[] { "a1", "b2" } }
		};
	...
	public void MoveAwayFromWithCertainty()
	{
		var nearText = new NearText
		{
			Concepts = new[] { "a", "b", "c" },
			Certainty = 0.8f,
			MoveAwayFrom = new() { Concepts = new[] { "a1", "b2" }, Force = 0.1f }
		};
		Assert.Equal(
	...
	public void MoveAwayFromWithCertaintyWithoutForce()
	{
		var nearText = new NearText
		{
			Concepts = new[] { "a", "b", "c" },
			Certainty = 0.8f,
			MoveAwayFrom = new() { Concepts = new[] { "a1", "b2" } }
		};
		Assert.Equal(
	...
	public void MoveToAndMoveAwayFromWithCertainty()
	{
		var nearText = new NearText
		{
			Concepts = new[] { "a", "b", "c" },
			Certainty = 0.8f,
			MoveTo = new() { Concepts = new[] { "z1", "y2" }, Force = 0.8f },
			MoveAwayFrom = new() { Concepts = new[] { "a1", "b2" }, Force = 0.1f }
		};
	...
	{
		var nearText = new NearText { Concepts = new[] { "a", "b", "c" }, Certainty = 0.8f, Autocorrect = false };
	...
	{
		var nearText = new NearText { Concepts = new[] { "a", "b", "c" }, Distance = 0.8f, Autocorrect = false };
	...
	{
		var nearText = new NearText { MoveTo = new() };
	...
	{
		var nearText = new NearText { MoveAwayFrom = new() };
	...
	{
		var nearText = new NearText { MoveTo = new(), MoveAwayFrom = new() };
	...
	public void MoveToWithObjectsAndCertaintyIdBeaconForce()
	{
		var nearText = new NearText
		{
			...
			MoveTo = new()
			{
				Objects = new[] { new ObjectMove { Id = "uuid" }, new ObjectMove { Beacon = "beacon" } },
				Force = 0.1f
			}
		};
		Assert.Equal(
	...
	public void MoveToWithObjectsAndCertaintyIdBeacon()
	{
		var nearText = new NearText
		{
			Concepts = new[] { "a", "b", "c" },
			Certainty = 0.8f,
			MoveTo = new() { Objects = new[] { new ObjectMove { Id = "uuid", Beacon = "beacon" } }, Force = 0.1f }
		};
		Assert.Equal(
			"nearText:{concepts: [\"a\",\"b\",\"c\"] certainty:0.8 moveTo:{force:0.1 objects: [{id:\"uuid\" beacon:\"beacon\"}]}}",
			nearText.ToString());
	...
	public void MoveToWithObjectsAndCertaintyId()
	{
		var nearText = new NearText
		{
			Concepts = new[] { "a", "b", "c" },
			Certainty = 0.8f,
			MoveTo = new() { Objects = new[] { new ObjectMove { Id = "uuid" } } }
		};
	...
	public void MoveToWithObjectsAndCertaintyBeacon()
	{
		var nearText = new NearText
		{
			Concepts = new[] { "a", "b", "c" },
			Certainty = 0.8f,
			MoveTo = new() { Objects = new[] { new ObjectMove { Beacon = "beacon" } } }
		};
		Assert.Equal(
	...
	public void MoveAwayFromWithObjectsAndCertaintyIdBeacon()
	{
		var nearText = new NearText
		{
			...
			MoveAwayFrom = new()
			{
				Objects = new[] { new ObjectMove { Id = "uuid", Beacon = "beacon" } }, Force = 0.1f
			}
		};
		Assert.Equal(
			"nearText:{concepts: [\"a\",\"b\",\"c\"] certainty:0.8 moveAwayFrom:{force:0.1 objects: [{id:\"uuid\" beacon:\"beacon\"}]}}",
	...
	public void MoveAwayFromWithObjectsAndCertaintyId()
	{
		var nearText = new NearText
		{
			Concepts = new[] { "a", "b", "c" },
			Certainty = 0.8f,
			MoveAwayFrom = new() { Objects = new[] { new ObjectMove { Id = "uuid" } } }
		};
		Assert.Equal(
	...
	public void MoveAwayFromWithObjectsAndCertaintyBeacon()
	{
		var nearText = new NearText
		{
			Concepts = new[] { "a", "b", "c" },
			Certainty = 0.8f,
			MoveAwayFrom = new() { Objects = new[] { new ObjectMove { Beacon = "beacon" } } }
		};
		Assert.Equal(
	...
	public void MoveToAndMoveAwayFromWithObjectsAndCertainty()
	{
		var nearText = new NearText
		{
			...
			MoveAwayFrom = new()
			{
				Objects = new[] { new ObjectMove { Id = "uuid", Beacon = "beacon" } }, Force = 0.2f
			}
		};
		Assert.Equal(
			"nearText:{concepts: [\"a\",\"b\",\"c\"] certainty:0.8 moveTo:{force:0.1 objects: [{id:\"uuid\"},{beacon:\"beacon\"}]} " +
