...
public class NearObjectTests : TestBase
{
	...
	{
		var nearObject = new NearObject { Id = "id", Beacon = "beacon", Certainty = 0.8f };
	...
	{
		var nearObject = new NearObject { Id = "id", Beacon = "beacon" };
	...
	{
		var nearObject = new NearObject { Id = "id", Beacon = "beacon", Distance = 0.8f };
	...
	{
		var nearObject = new NearObject { Beacon = "beacon", Certainty = 0.4f };
	...
	{
		var nearObject = new NearObject { Beacon = "beacon", Distance = 0.4f };
	...
	{
		var nearObject = new NearObject { Id = "id", Certainty = 0.1f };
	...
	{
		var nearObject = new NearObject { Id = "id", Distance = 0.1f };
